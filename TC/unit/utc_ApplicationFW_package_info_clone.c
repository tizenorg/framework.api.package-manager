...
static void utc_ApplicationFW_package_info_clone_func_01(void);
static void utc_ApplicationFW_package_info_clone_func_02(void);
...
struct tet_testlist tet_testlist[] = {
	{utc_ApplicationFW_package_info_clone_func_01, POSITIVE_TC_IDX},
	{utc_ApplicationFW_package_info_clone_func_02, NEGATIVE_TC_IDX},
	{NULL, 0},
};
...
static void utc_ApplicationFW_package_info_clone_func_02(void)
{
	...
	ret = package_info_clone(-1, clone_info);
	if (ret != 0) {
		tet_infoline
		    ("tc() failed in positive test case");
		tet_result(TET_FAIL);
